...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta charset="UTF-8">
        <title>Bienvenue sur sabluximmoplus.com</title>
    ...
    <div class="container">
    <div class="logo">
    <img src="{{asset('pages-assets/index_logo_tmp.png?1655381518')}}" alt="">
    </div>
    <div class="content"><h1>Location - Vente - G&eacute;rance - Travaux/R&eacute;fections - Home Staging -&nbsp;Syndic - Conciergerie</h1>
    <p>Ce site est actuellement en construction.<br />T&eacute;l&nbsp;: 33 869 60 30&nbsp; &nbsp; &nbsp;Mail : immoplus@sabluxgroup.com</p></div>
    <div class="social-links">
    <a href="https://facebook.com/ImmoplusSablux" target="_blank" title="Facebook"><em class="fa fa-facebook-square fa-lg"></em></a>
    <a href="https://www.instagram.com/immoplus_its_sablux" target="_blank" title="Instagram"><em class="fa fa-instagram fa-lg">&nbsp;</em></a>
    </div>
