...
@section('page-title')
    {{__('Liste des types')}}
    <x-audit-link model-name="Locationtype" />
@endsection

@section('content')
<div class="flex space-x-2 justify-center">
    <a href="{{route('bo.location_types.create')}}"
       ...
       focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-150 ease-in-out">
        <i class="fa fa-user-plus"></i> Ajouter un type
    </a>
</div>
<div class="w-full px-6 py-4" x-data="confirmationModal()">
    <livewire:datatable-of-location-types />
</div>
@endsection
