<div x-data class="flex flex-col">
    <div class="w-full relative flex">
        ...
        <div class="absolute inset-y-0 right-0 pr-2 flex items-center">
            <button x-on:click="$refs.start.value=''" wire:click="doTimeFilterStart('{{ $index }}', '')" class="-mb-0.5 pr-1 flex text-gray-400 hover:text-red-600 focus:outline-none" tabindex="-1" aria-label="stroke">
    ...
    <div class="w-full relative flex">
       ...
       <div class="absolute inset-y-0 right-0 pr-2 flex items-center">
            <button x-on:click="$refs.end.value=''" wire:click="doTimeFilterEnd('{{ $index }}', '')" class="-mb-0.5 pr-1 flex text-gray-400 hover:text-red-600 focus:outline-none" tabindex="-1" aria-label="stroke">
                <x-icons.x-circle class="h-5 w-5 stroke-current text-white" />
            </button>
        </div>
    </div>
